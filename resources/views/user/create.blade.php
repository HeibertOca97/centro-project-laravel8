...
@section('section-content')
  ...
  <div class="container-xl btn-white">
    <h1 class="title-module">Crear usuario</h1>
  </div>
  ...
  <div class="card container-xl">
    ...
    <form action="{{route('users.store')}}" method="post" id="formUser">
        ...
        <div class="form-group">
          ...
          <input type="text" name="username" class="form-control required @if ($errors->has('username')) border-danger @endif" id="username" aria-describedby="username-description" autocomplete="off" value="{{old('username')}}">
        ...
        <div class="form-group">
          ...
          <input type="email" name="email" class="form-control required @if ($errors->has('email')) border-danger @endif" id="email" aria-describedby="email-description" autocomplete="off" value="{{old('email')}}">
        ...
        <div class="form-group">
          ...
          <input type="password" name="password" class="form-control required @if ($errors->has('password')) border-danger @endif" id="password" value="{{old('password')}}">
        ...
        <div class="form-group">
          ...
          <div>
            <div class="form-check form-check-inline" id="estado-check">
              <input class="form-check-input" type="radio" name="status" id="status_active" value="{{old('estado','1')}}">
              <label class="form-check-label check-default" for="status_active">Activo</label>
            </div>
            <div class="form-check form-check-inline" id="estado-check">
              <input class="form-check-input" type="radio" name="status" id="status_inactive" value="{{old('estado','0')}}">
        ...
        <div class="form-group">
          ...
          <div>
            ...
            <div class="form-check form-check-inline" id="rol-check">
              <input class="form-check-input" type="radio" name="rol" id="id-{{$rol}}" value="{{old('rol',$rol)}}">
