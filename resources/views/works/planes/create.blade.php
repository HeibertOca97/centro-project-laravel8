  ...
  <div class="card container-xl">
    ...
    <form action="{{route('planes.store')}}" method="post" id="formPlanTrabajo">
        ...
        <div class="mb-4">
          ...
          <textarea class="form-control @error('evento') border-danger @enderror" id="eventos" rows="3" name="evento" maxlength="255" style="max-height: 150px;min-height:80px;" data-name="evento">{{old('evento')}}</textarea>
        ...
        <div class="mb-4 mt-4">
          ...
          <input type="text" class="form-control @if ($errors->has('lugar')) border-danger @endif text" id="lugar" value="{{old('lugar')}}" maxlength="100" autocomplete="off" name="lugar" data-name="lugar">
        ...
        <div class="mb-4 mt-4">
          ...
          <textarea class="form-control @error('responsables') border-danger @enderror text" id="responsables" rows="3" name="responsables" maxlength="200" style="max-height: 150px;min-height:80px;" data-name="responsables">{{old('responsables')}}</textarea>
        ...
        <div class="mb-4 mt-4">
          ...
          <input type="text" class="form-control @if ($errors->has('hora')) border-danger @endif" id="hora" value="{{old('hora')}}" maxlength="50" autocomplete="off" name="hora" data-name="hora">
