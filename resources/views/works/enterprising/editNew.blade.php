          ...
          <div class="row border rounded mt-3 mb-3">
            <div class="col-sm-6">
              <div class="form-group mt-4 mb-4">
                ...
                <input type="date" name="fec_nac" class="form-control @if ($errors->has('fec_nac')) border-danger @endif required" id="fec_nac" aria-describedby="fecha_n-description" autocomplete="off" value="{{old('fec_nac',$emp->fec_nac)}}" data-name="fecha de nacimiento">
                <small id="fecha_n-description" class="form-text @error('fec_nac')text-danger @enderror">@error('fec_nac') {{$message}} @enderror</small>
              </div><hr>
              <div class="form-group mt-4 mb-4">
                <label for="cedula de identidad"class="@if ($errors->has('cedula')) text-danger @else text-secondary @endif label-description">Cedula de identidad *</label>
                <input type="number" name="cedula" class="form-control @if ($errors->has('cedula')) border-danger @endif num required" id="cedula de identidad" aria-describedby="cedula-description" autocomplete="off" value="{{old('cedula',$emp->cedula)}}" maxlength="10" data-name="cedula de identidad">
              ...
              <div class="form-group mt-4 mb-4">
                ...
                <input type="text" name="nombres" class="form-control @if ($errors->has('nombres')) border-danger @endif text required" id="nombres" aria-describedby="nombres-description" autocomplete="off" value="{{old('nombres',$emp->nombres)}}" maxlength="50" data-name="nombres">
              ...
              <div class="form-group mt-4 mb-4">
                ...
                <input type="text" name="apellidos" class="form-control @if ($errors->has('apellidos')) border-danger @endif text required" id="apellidos" aria-describedby="apellidos-description" autocomplete="off" value="{{old('apellidos',$emp->apellidos)}}" maxlength="50" data-name="apellidos">
              ...
              <div class="form-group mt-4 mb-4">
                ...
                <input type="email" name="email" class="form-control @if ($errors->has('email')) border-danger @endif required" id="email" aria-describedby="email-description" autocomplete="off" value="{{old('email',$emp->email)}}" maxlength="100" placeholder="usuario@servidor.dominio" data-name="email">
              ...
              <div class="form-group mt-4 mb-4">
                ...
                <input type="text" name="ciudad" class="form-control @if ($errors->has('ciudad')) border-danger @endif text required" id="ciudad" aria-describedby="ciudad-description" autocomplete="off" value="{{old('ciudad',$p->ciudad)}}" maxlength="100" data-name="ciudad">
            ...
            <div class="col-sm-6">
              <div class="form-group mb-4 mt-4">
                ...
                <textarea class="form-control @error('direccion') border-danger @enderror required text" id="direccion" rows="3" name="direccion" maxlength="200" style="max-height: 150px;min-height:80px;" data-name="direccion">{{old('direccion',$p->direccion)}}</textarea>
              ...
              <div class="row">
                <div class="form-group mt-4 mb-4 col-sm-6">
                  ...
                  <input type="number" name="celular" class="form-control @if ($errors->has('celular'))border-danger @endif required num" id="celular" aria-describedby="celular-description" autocomplete="off" value="{{old('celular',$emp->celular)}}" maxlength="10" data-name="celular">
                ...
                <div class="form-group mt-4 mb-4 col-sm-6">
                  ...
                  <input type="number" name="telefono" class="form-control @if ($errors->has('telefono')) border-danger @endif num" id="telefono" aria-describedby="telefono-description" autocomplete="off" value="{{old('telefono',$emp->telefono)}}" maxlength="10" data-name="telefono">
              ...
              <div class="form-group mt-4 mb-4" id="nom_instituto">
                ...
                <textarea class="form-control @error('estudio') border-danger @enderror text" id="estudio" rows="3" name="estudio" maxlength="255" style="max-height: 150px;min-height:70px;" data-name="¿En que universidad estudiaste?">{{old('estudio',$p->nom_universidad)}}</textarea>
            ...
            <div class="row border rounded mt-3 mb-3">
              <div class="col-sm-6">
                <div class="form-group mt-4 mb-4">
                  ...
                  <input type="text" name="nom_idea" class="form-control @if ($errors->has('nom_idea')) border-danger @endif required" id="nom_idea" maxlength="255" aria-describedby="nom_idea-description" autocomplete="off" value="{{old('nom_idea',$in->nom_idea)}}" data-name="idea de negocio">
                  <small id="nom_idea-description" class="form-text @error('nom_idea')text-danger @enderror">@error('nom_idea') {{$message}} @enderror</small>
                </div><hr>
                <div class="form-group mt-4 mb-4">
                  <label for="t_plan"class="@if ($errors->has('t_plan')) text-danger @else text-secondary @endif label-description d-block">2. ¿Tiene redactado un plan de negocio?</label>
                  @foreach ($opt2 as $op)
                ...
                <div class="form-group mt-4 mb-4">
                  ...
                  <input type="text" name="sector_act" class="form-control @if ($errors->has('sector_act')) border-danger @endif text" id="sector_act" aria-describedby="sector_act-description" autocomplete="off" value="{{old('sector_act',$in->sector_act)}}" maxlength="255" data-name="¿pregunta 3?">
                ...
                <div class="form-group mb-4 mt-4">
                  ...
                  <textarea class="form-control @error('consumidor') border-danger @enderror text" id="consumidor" rows="3" name="consumidor" maxlength="255" style="max-height: 150px;min-height:80px;" data-name="¿pregunta 4?">{{old('consumidor',$in->consumidores)}}</textarea>
                ...
                <div class="form-group mb-4 mt-4">
                  ...
                  <textarea class="form-control @error('competidor') border-danger @enderror text" id="competidor" rows="3" name="competidor" maxlength="255" style="max-height: 150px;min-height:80px;" data-name="¿pregunta 5?">{{old('competidor',$in->competidores)}}</textarea>
              ...
              <div class="col-sm-6">
                <div class="form-group mb-4 mt-4">
                  ...
                  <textarea class="form-control @error('habilidades') border-danger @enderror text" id="habilidades" rows="3" name="habilidades" maxlength="255" style="max-height: 150px;min-height:80px;" data-name="¿pregunta 6?">{{old('habilidades',$in->habilidades)}}</textarea>
                ...
                <div class="form-group mb-4 mt-4">
                  ...
                  <textarea class="form-control @error('debilidades') border-danger @enderror text" id="debilidades" rows="3" name="debilidades" maxlength="255" style="max-height: 150px;min-height:80px;" data-name="¿pregunta 7?">{{old('debilidades',$in->debilidades)}}</textarea>
                ...
                <div class="form-group mb-4 mt-4">
                  ...
                  <textarea class="form-control @error('t_apoyo') border-danger @enderror text" id="t_apoyo" rows="3" name="t_apoyo" maxlength="255" style="max-height: 150px;min-height:80px;" data-name="¿pregunta 8?">{{old('t_apoyo',$in->t_apoyo)}}</textarea>
...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  @endif
  @foreach ($ne->all() as $nivel)
    @if($p->niveleducativo_id == "{$nivel->id}")
    toggleElementAnswerEnterprisingError();
    @endif
  @endforeach
